...
<button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" class="inline-flex items-center p-2 mt-2 ml-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
 ...
 <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
       <a href="/lectures" class="flex items-center pl-2.5 mb-5">
          <img src="{{asset ('assets/images/kodego.png')}}" alt="">
       ...
       <ul class="space-y-2 font-medium">
          ...
          <li>
             <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <span class="flex-1 ml-3 whitespace-nowrap"><b style="color: red">LECTURE LIST</b></span>
               
             </a>
          </li>
          <li>
            <a href="/admin/studentlist" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
                    ...
                    <button type="button" id="createProductModalButton" data-modal-target="add-lecture" data-modal-toggle="add-lecture" class="flex items-center justify-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
                        <svg class="h-3.5 w-3.5 mr-2" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            <path clip-rule="evenodd" fill-rule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 11-2 0v-5H4a1 1 0 110-2h5V4a1 1 0 011-1z" />
                        </svg>
                       ADD LECTURE
                    </button>
                    <!-- end of button add lecture  -->
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            <th scope="col" class="px-4 py-4">LECTURE NAME</th>
                            <th scope="col" class="px-4 py-3">TAGS</th>
                            <th scope="col" class="px-4 py-3">IMAGE</th>
                            <th scope="col" class="px-4 py-3">LECTURE LINK</th>
                    ...
                    <tbody>
                        <tr class="border-b dark:border-gray-700">
                            <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">HTML INTRO </th>
                            <td class="px-4 py-3">HTML,CSS</td>
                            <td class="px-4 py-3">/IMAGE/assets/kineme</td>
                            <td class="px-4 py-3">YOUTUBE.COM </td>
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div id="apple-imac-27-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                    <ul class="py-1 text-sm" aria-labelledby="apple-imac-27-dropdown-butto">
                                        <li>
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div class="flex justify-between items-center pb-4 mb-4 rounded-t border-b sm:mb-5 dark:border-gray-600">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">EDIT LECTURE</h3>
                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select id="image" type="text" name="image" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <option value="/assets/images/tech-stack/no-image.png">Select Image</option>
                            ...
                            <option value="/assets/images/tech-stack/git.png">GIT</option>
                            <option value="/assets/images/tech-stack/github.png">GITHUB</option>
                            ...
                            <option value="/assets/images/tech-stack/installation.png">INSTALLATION</option> 
                            <option value="/assets/images/tech-stack/activity.png">ACTIVITY</option> 
                        </select>
                    </div>
                    ...
                    <button type="update-lecture" class="text-dark inline-flex items-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
...
<div id="readProductModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-xl max-h-full">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <dl><dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">USERNAME</dt><dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">
                USERNAME: TOMENIO
            </dd>
            <dl><dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">PASSWORD</dt><dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">
                PASSWORD: 123456
            </dd>
            <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">STATUS</dt>
            <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">Lecture STATUS: ACTIVE</dd></dl>
...
<div id="deleteModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
 ...
 <section>
    <!-- Main modal -->
    <div id="add-user" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <select id="status" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
                                <option value="ST">ACTIVE</option>
                                <option value="AD">INACTIVE</option>
    ...
    <!-- modal add lecture  -->
    <div id="add-lecture" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
        <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
            <!-- Modal content -->
            <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                <!-- Modal header -->
